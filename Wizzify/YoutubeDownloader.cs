    ...
    class YoutubeDownloader
    {
        ...
        public async Task Coverter() {
            ...
            try {
                ...
                string exeFile = "/C C:\\Users\\yfben\\source\\repos\\Wizzify\\Wizzify\\youtube-dl";
                string strCmdText;
                ...
                if (!(files.Length == 0))
                {
                    ...
                    {
                        ffMpeg.ConvertMedia(file, file.Replace(".mp4", ".mp3"), ".mp3");
                    }
                }
                else
                {
                    MessageBox.Show("Empty Directory", "Notification");
                }
            } catch(Exception ex){
